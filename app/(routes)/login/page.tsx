        ...
        <HStack w={"full"} h={"full"}>
            ...
            <Box display={"flex"} alignItems={"center"} justifyContent={"center"} position={"relative"} w={"full"} h={"full"}>
                ...
                <Center zIndex={"10"} className="drop-shadow-xl" flexDirection={"column"} px={"20px"} rowGap={"15px"} border={"1px"} borderColor={"gray.100"} h={"fit-content"} py={"40px"} borderRadius={"5px"} bgColor={"white"} w={"70%"} >
                    <Heading size={"lg"} mb={"20px"} >User Login</Heading>
                    <Link href="/signup" display={"flex"}>Dont Have Account? <Text color={"blue"}>Sign Up</Text> </Link>
                    ...
                    <HStack></HStack>
                    <Button w={"full"} bg={"blue.400"} textColor={"white"}>LOGIN</Button>
                    <Text fontWeight={"bold"}>Login with Social Media :</Text>
                    <HStack columnGap={"20px"}>
                        <Image w={"30px"} height={"30px"} objectFit={"contain"} src="/icons/google.png" />
                        <Image w={"30px"} height={"30px"} objectFit={"contain"} src="/icons/github.png" />
                    </HStack>
